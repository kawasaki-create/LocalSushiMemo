        ...
        body: Center(
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text('あなたが次に食べるのは・・・\n\n'),
                Text(sushiroMenuName[RandomArg]),
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                        onPressed: (){
                          ateList.add(sushiroMenuName[RandomArg]);
                          setState(() {
                            RandomArg =  Random().nextInt(sushiroMenuName.length);
                          });
                        },
                        child: Text('食べた')
                    ),
